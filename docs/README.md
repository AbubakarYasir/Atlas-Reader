...
6. **`TOOLCHAIN.md`** — canonical N1 Windows/MSVC/Qt build baseline and drift policy.
7. **`baselines/N1_WINDOWS_BASELINE.md`** — active target-machine performance/RTL/scale evidence sheet.
...
- **`TOOLCHAIN.md`** — exact N1 Windows alpha toolchain policy.
...
- **`BUILDING.md`** — local/CI build instructions and N1 benchmark commands.
...
- **`baselines/N1_WINDOWS_BASELINE.md`** — active N1 evidence and owner test sheet.
...
6. `TOOLCHAIN.md` defines the active Windows alpha toolchain policy.
7. Specialized docs define their domain contract.
8. Older prose must be corrected rather than used to justify contradictory behavior.
