...
void main() {
  ...
  test(
    'Stage 10: Reading session tabs are persisted and restored from SQLite',
    () async {
      final tabsToSave = [
        (
          filePath: 'C:\\Books\\Arabic_Original.pdf',
          pageNumber: 15,
          isActive: true,
        ),
        (
          filePath: 'C:\\Books\\English_Translation.pdf',
          pageNumber: 22,
          isActive: false,
        ),
      ...
      final savedNote = await db.getScratchpadNote(
        'C:\\Books\\Arabic_Original.pdf',
      );
  ...
  testWidgets(
    'Stage 10: ResearchScratchpad supports formatting, quotes, and page links',
    (tester) async {
      int? jumpedPage;
      ...
      expect(
        ...
        contains('[Page 42](atlas://page/42)'),
      );
