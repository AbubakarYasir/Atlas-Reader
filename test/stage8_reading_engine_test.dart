...
void main() {
  test('Stage 8: ReaderPreferences supports reading modes, themes, offsets, and cropping', () {
  ...
  testWidgets('Stage 8: ReaderThumbnailJumper displays page grid and direct jump field', (tester) async {
    int? selectedPage;
  ...
  testWidgets('Stage 8: ReaderScrubBar reflects progress, mode, and jumps', (tester) async {
    int? navigatedPage;
  ...
  testWidgets('Stage 8: ReaderSettingsDialog updates theme, mode, and margin cropping', (tester) async {
